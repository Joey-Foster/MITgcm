...
#endif /* BATHY_HOMOG_3D_STATE */
#ifdef BATHY_HOMOG_2D_STATE
C     MYPA 2-dim. fields
...
#endif /* BATHY_HOMOG_2D_STATE */

#ifdef BATHY_HOMOG_TENDENCY
