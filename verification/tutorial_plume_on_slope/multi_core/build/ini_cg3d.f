...
C                 on cg3dNormaliseRHS, solver-unit ^2 = (m2/s2)^2 or no unit)
     ...
     &      cg3dNorm, cg3dTolerance_sq
      ...
      Real*8  cg3dNorm, cg3dTolerance_sq
...
C     cg3d_s ::   idem
     ...
     & cg3d_q, cg3d_r, cg3d_s
      Real*8  cg3d_q( 0:sNx+1, 0:sNy+1, Nr,nSx,nSy)
      Real*8  cg3d_r( 0:sNx+1, 0:sNy+1, Nr,nSx,nSy)
      Real*8  cg3d_s( 0:sNx+1, 0:sNy+1, Nr,nSx,nSy)
