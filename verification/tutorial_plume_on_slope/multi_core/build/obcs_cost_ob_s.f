...
CBOP
C !ROUTINE: OBCS_COST_OB_S

C !INTERFACE: ==========================================================
      SUBROUTINE OBCS_COST_OB_S(
     I                           startrec, endrec,
     I                           myTime, myIter, myThid )

C !DESCRIPTION:
C     - Calculatesd cost function contribution (Tikhonov regulariation)
C       of southern open-boundary
